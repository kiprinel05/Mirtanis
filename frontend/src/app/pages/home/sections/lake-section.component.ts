  ...
  template: `
    <section class="relative overflow-hidden">
      ...
      <div class="container-x relative py-24 text-center text-cream-50 sm:py-32 lg:py-40">
        ...
        <h2 class="mx-auto mt-4 max-w-3xl font-display text-4xl text-cream-50 sm:text-5xl lg:text-6xl" appReveal="up" [revealDelay]="100">
...
export class LakeSectionComponent {
  ...
  readonly stats = [
    { value: 300, suffix: '+', label: 'Evenimente' },
    { value: 500, suffix: '', label: 'Invitați capacitate' },
