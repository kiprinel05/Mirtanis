      ...
      <div class="container-x relative py-12 sm:py-16 lg:py-20">
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="grid grid-cols-2 gap-8 md:col-span-2 lg:contents">
            <div>
              <h4 class="mb-3 text-xs uppercase tracking-widest2 text-gold-200">Navigare</h4>
          ...
          <!-- CTA -->
          <div>
            <h4 class="mb-3 text-xs uppercase tracking-widest2 text-gold-200">Plănuiește vizita</h4>
        ...
        <div class="mt-10 flex flex-col items-center gap-2 border-t border-cream-100/15 pt-6 text-center text-xs text-cream-100/50 sm:flex-row sm:justify-between sm:text-left">
